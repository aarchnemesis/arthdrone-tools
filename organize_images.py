...
def normalize_filename_api_api(name: str) -> str:
...
def organizar_imagens_api(lang="pt"):
    print(Fore.CYAN + f"\n=== {t('option_1', lang)} ===\n" + Style.RESET_ALL)
    ...
    if dry:
        print(Fore.YELLOW + f"[DRY-RUN] {copied} imagens seriam copiadas (nada foi alterado)." + Style.RESET_ALL)
    else:
